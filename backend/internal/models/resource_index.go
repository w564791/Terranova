...
type ResourceIndex struct {
	...
	SummaryAssessmentStatus  string `gorm:"column:summary_assessment_status;type:varchar(16);default:''" json:"summary_assessment_status,omitempty"` // 摘要评估状态：空 | pending | partial | assessed
